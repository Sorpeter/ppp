...
u , res = https.request('https://PETER-source.xyz/PETERTeAM/Calculateage.php?age='..Textage)
...
if Redis:get(PETER..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(PETER..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(PETER..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local albnt = LuaTele.getUser(zoog2)
fne = Redis:get(PETER..':toob:Name:'..zoog2)
albnt = "["..fne.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ الحق ي : "..albnt.." زوجك يبي يتزوج ","md")
end
if Redis:get(PETER..msg_chat_id..msg.sender.user_id.."bnttt2:") then
local zwga_id = Redis:get(PETER..msg_chat_id..msg.sender.user_id.."bnttt2:") 
local zoog2 = Redis:get(PETER..msg_chat_id..zwga_id.."rgalll2:") 
...
local Message_Reply = LuaTele.getMessage(msg.chat_id, msg.reply_to_message_id)
if Redis:get(PETER..msg_chat_id..Message_Reply.sender.user_id.."rgalll2:") or Redis:get(PETER..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:") then
...
local zwga_id = Redis:get(PETER..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:set(PETER..msg_chat_id..Message_Reply.sender.user_id.."bnttt2:", msg.sender.user_id)
Redis:set(PETER..msg_chat_id..msg.sender.user_id.."rgalll2:", Message_Reply.sender.user_id)
Redis:set(PETER..msg_chat_id..Message_Reply.sender.user_id.."mhrrr2:", UserNameyy)
Redis:set(PETER..msg_chat_id..msg.sender.user_id.."mhrrr2:", UserNameyy)
...
Redis:decrby(PETER.."nool:flotysb"..msg.sender.user_id , UserNameyy)
Redis:incrby(PETER.."nool:flotysb"..Message_Reply.sender.user_id , UserNameyy)
Redis:incrby(PETER.."mznom"..msg_chat_id..msg.sender.user_id , UserNameyy)
Redis:sadd(PETER.."almtzog"..msg_chat_id,msg.sender.user_id)
...
local zwga_id = Redis:get(PETER..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(PETER..msg_chat_id..zwga_id.."rgalll2:") 
local mhrr = Redis:get(PETER..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fne = Redis:get(PETER..':toob:Name:'..zwga_id)
alzog = "["..fne.."](tg://user?id="..zwga_id..") "
local albnt = LuaTele.getUser(zoog2)
fnte = Redis:get(PETER..':toob:Name:'..zoog2)
albnt = "["..fnte.."](tg://user?id="..zoog2..") "
return LuaTele.sendText(msg_chat_id,msg_id,"⋆ عقد زواجكم\n⋆ الزوج : "..alzog.."\n⋆ الزوجه : "..albnt.." \n⋆ المهر : "..mhrr.." جنيه ","md")
end
if Redis:get(PETER..msg_chat_id..msg.sender.user_id.."rgalll2:") then
local zwga_id = Redis:get(PETER..msg_chat_id..msg.sender.user_id.."rgalll2:") 
local zoog2 = Redis:get(PETER..msg_chat_id..zwga_id.."bnttt2:") 
local mhrr = Redis:get(PETER..msg_chat_id..msg.sender.user_id.."mhrrr2:")
local id_rgal = LuaTele.getUser(zwga_id)
fnte = Redis:get(PETER..':toob:Name:'..zwga_id)
...
if text == "خلع" then
if not Redis:get(PETER..msg_chat_id..msg.sender.user_id.."bnttt2:") then
...
alzog = " "..gg.first_name.." "
local zwga_id = Redis:get(PETER..msg_chat_id..msg.sender.user_id.."bnttt2:") 
Redis:incrby(PETER.."nool:flotysb"..zwga_id,mhrr)
Redis:decrby(PETER.."nool:flotysb"..msg.sender.user_id,mhrr)
Redis:del(PETER.."mznom"..msg_chat_id..zwga_id)
Redis:srem(PETER.."almtzog"..msg_chat_id,zwga_id)
Redis:del(PETER.."mznom"..msg_chat_id..msg.sender.user_id)
Redis:srem(PETER.."almtzog"..msg_chat_id,msg.sender.user_id)
Redis:del(PETER..msg_chat_id..msg.sender.user_id.."mhrrr2:")
Redis:del(PETER..msg_chat_id..zwga_id.."mhrrr2:")
Redis:del(PETER..msg_chat_id..msg.sender.user_id.."bnttt2:")
Redis:del(PETER..msg_chat_id..zwga_id.."bnttt2:")
Redis:del(PETER..msg_chat_id..msg.sender.user_id.."rgalll2:")
Redis:del(PETER..msg_chat_id..zwga_id.."rgalll2:")
LuaTele.sendText(msg_chat_id,msg_id,"⋆ تم خلعت زوجك "..alzog.." \n ورجعت له "..mhrr.." جنيه","md")
end
if text == "طلاق"  then
if not Redis:get(PETER..msg_chat_id..msg.sender.user_id.."rgalll2:") then
